...
echo "Submitting contraction optimization job."
echo " "
...
if [ -f "contraction_opt.input" ]; then
    sed '/### GLOBAL VAR FROM INPUT ###/ r contraction_opt.input' $ML_SDIR/contraction_optimization.py > ./contraction_optimization.py 
    python3 ./contraction_optimization.py
else
